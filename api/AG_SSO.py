...
REGION_LOS_LAGOS = 10
RUT_SSO = "616076000"  # Servicio de Salud Osorno (sin puntos ni guión)
...
def _extraer_tablas_normalizadas(detalle: Dict[str, Any]) -> Tuple[
    ...
    orden_compra = detalle.get("orden_compra", {})
    ...
    resumen = {
        ...
        # Orden de Compra
        "OC_ID": orden_compra.get("id_orden_compra"),
        "OC_Codigo": orden_compra.get("codigo_orden_compra"),
        "OC_Estado": orden_compra.get("estado_orden_compra"),
    ...
    for prov in detalle.get("proveedores_cotizando", []):
        estado_cotizacion = prov.get("estado_cotizacion", {})
        seleccion = prov.get("seleccion", {})
        fechas_prov = prov.get("fechas", {})
        montos = prov.get("montos", {})
        ...
        proveedores.append({
            ...
            # Estado cotización
            "EstadoCotizacionID": estado_cotizacion.get("id"),
            "EstadoCotizacionGlosa": estado_cotizacion.get("glosa"),
            
            # Selección
            "ProveedorSeleccionado": seleccion.get("proveedor_seleccionado"),
            "MotivoSeleccion": limpiar(seleccion.get("motivo_seleccion")),
            "CriterioSeleccion": limpiar(seleccion.get("criterio_seleccion")),
            
            # Fechas
            "FechaCreacion": fechas_prov.get("fecha_creacion"),
            "FechaVigencia": fechas_prov.get("fecha_vigencia"),
            
            # Montos
            "ValorNeto": montos.get("valor_neto"),
            "TotalImpuesto": montos.get("total_impuesto"),
            "MontoDespacho": montos.get("monto_despacho"),
            "MontoTotal": montos.get("monto_total"),
            "NombreImpuesto": montos.get("nombre_impuesto"),
            "PorcentajeImpuesto": montos.get("porcentaje_impuesto"),
