...
# ===== IMPORTS DE VISTAS =====
from pages.OrdenCompraButton.proveedores import vista_proveedores
from pages.OrdenCompraButton.oc_ultimas import vista_ultimas
...
st.markdown(
    ...
    ">
        ...
        <div style="font-size: 15px; opacity: 0.9; margin-top: 4px;">
            Este módulo entrega la visualización de las Ordenes de Compra 
        </div>
    </div>
    """,
    unsafe_allow_html=True
